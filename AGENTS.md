...
config/silence-deadline  optional per-home silence-sentry deadline in seconds before an unwatched home is reported; LOCAL, gitignored, and not inherited; absent means 2700 (45 minutes), floored at the watcher grace; see docs/watcher-continuity.md
