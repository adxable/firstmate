...
The spawn must resolve a genuine isolated task worktree that is distinct from the primary checkout and not already recorded as another live task's worktree; a failed isolation assertion stops the task.
