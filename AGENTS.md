...
The spawn must resolve a genuine isolated task worktree that is distinct from the primary checkout and not already recorded as the worktree of another task whose endpoint is proven to still exist; a failed isolation assertion stops the task.
