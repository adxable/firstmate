...
# It deliberately does NOT bundle the behavior-specific fake tmux/treehouse/
# no-mistakes mocks: those encode terminal and lifecycle assumptions that differ
# per suite and belong with the tests that own them.
#
