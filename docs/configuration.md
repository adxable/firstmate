...
FM_ARM_CONFIRM_TIMEOUT=10   # seconds fm-watch-arm waits to confirm a fresh watcher before reporting FAILED, and the same window the --claude guard's last-resort arm confirms its own launch in; default 30 on Git Bash/MSYS
