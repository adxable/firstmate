...
family_for_basename() {
  case "$1" in
    ...
    fm-silence-sentry-live-e2e.test.sh|\
    ...
    fm-tmux-target-fallback-live-e2e.test.sh|\
    fm-treehouse-pool-termination-live-e2e.test.sh|\
    fm-herdr-submit-confirm-live-e2e.test.sh)
      printf '%s\n' live-harness-optin
      ;;
    fm-backend-herdr.test.sh|fm-backend-tmux-smoke.test.sh|fm-backend.test.sh|\
    fm-tmux-agent-liveness.test.sh|fm-tmux-target-proof.test.sh|\
...
tests/fm-silence-sentry-live-e2e.test.sh 21
tests/fm-silence-sentry.test.sh 89030
