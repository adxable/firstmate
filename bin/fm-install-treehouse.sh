...
#
# Pins Treehouse v2.3.0, the version the per-home worktree pool root needs: it
# honors a configured root, which v2.0.1 does not (see
# docs/verification/runtime-backends.md "Treehouse").
set -eu
