...
Primary `.claude/settings.json` registers `../../../bin/fm-turnend-guard.sh --claude` with `timeout: 180` and `../../../bin/fm-claude-stop-autoarm.sh` with `asyncRewake: true` and `timeout: 28800`.
